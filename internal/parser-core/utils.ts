...
import {catchDiagnosticsSync, DiagnosticCategory} from "@internal/diagnostics";
...
): (opts: Types["options"], meta: Types["meta"], diagnosticCategory?: DiagnosticCategory) => ParserCore<Types> {
	return (opts: Types["options"], meta: Types["meta"], diagnosticCategory?: DiagnosticCategory) => {
